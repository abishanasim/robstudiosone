...
SDF_POSES = {
    # row A (north)
    "pinea": (0.0,  9.7,  0.0, 0.0, 0.0, 0.9),
    "pineb": (0.0,  7.55, 0.0, 0.0, 0.0, 0.9),
    "pinec": (0.0,  5.4,  0.0, 0.0, 0.0, 0.9),
    "pined": (0.0,  3.25, 0.0, 0.0, 0.0, 0.9),

    # central strip (slightly different yaws)
    "pine1": (0.0,  1.10, 0.0, 0.0, 0.0, 0.1),
    "pine2": (0.0, -1.05, 0.0, 0.0, 0.0, 0.3),
    "pine3": (0.0, -3.25, 0.0, 0.0, 0.0, 0.2),
    "pine4": (0.0, -5.40, 0.0, 0.0, 0.0, 0.0),
    "pine5": (0.0, -7.60, 0.0, 0.0, 0.0, 0.5),
    "pine6": (0.0, -9.70, 0.0, 0.0, 0.0, 0.9),
}
